...
async def start(bot: Client, cmd: Message):
    ...
    if usr_cmd == "/start":
        ...
        await cmd.reply_photo("https://graph.org/file/edcb909a4252566a6ab2a.jpg",
...
async def main(bot: Client, message: Message):
    ...
    if message.chat.type == enums.ChatType.PRIVATE:
        ...
        try:
            ...
            share_link = f"https://telegram.dog/{Config.BOT_USERNAME}?start=tgnvs_{str_to_b64(file_er_id)}"
...
async def button(bot: Client, cmd: CallbackQuery):
    ...
    if "aboutbot" in cb_data:
        ...
        await cmd.message.edit("File Saved in Batch!\n\n"
                               ...
                               reply_markup=InlineKeyboardMarkup([
                                   [InlineKeyboardButton("Generate Batch Link", callback_data="getBatchLink")],
